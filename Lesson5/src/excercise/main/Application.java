...
import excercise.service.CountableImp;

public class Application {

    public static void main(String[] args) {
        Countable counter = new CountableImp();
        ...
        System.out.println(counter.countWordsStartByChar(text, ch));

    }
    public static  void printResult (Countable countable, String text, char ch)
